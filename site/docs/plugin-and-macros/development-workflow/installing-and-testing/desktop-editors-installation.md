...
There are two ways to install a plugin in Desktop Editors.
...
Use the plugin **GUID** from `config.json` as the folder name (for example, `{91EAC419-EF8B-440C-A960-B451C7DF3A37}`). Restart Desktop Editors after placing the folder.
