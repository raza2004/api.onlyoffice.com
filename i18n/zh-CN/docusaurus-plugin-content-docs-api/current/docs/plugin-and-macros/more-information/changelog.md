...
- 为文本文档 API 的 window.Asc.plugin.executeMethod 添加了[获取当前书签](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetCurrentBookmark.md)方法。
- 为演示文稿 API 的 window.Asc.plugin.executeMethod 添加了[前往幻灯片页面](../interacting-with-editors/api-by-editor-type/presentation-api/Methods/GoToSlide.md)方法。
- 添加了[内容控件列表元素](../interacting-with-editors/api-by-editor-type/text-document-api/Enumeration/ContentControlListElement.md)枚举。

## 版本 8.3 {#version-83}

- 向 *window.Asc.plugin.executeMethod* 添加了[获取选中内容](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetSelectedContent.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[显示错误](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/ShowError.md)方法。
- 向[内容控件属性](../interacting-with-editors/api-by-editor-type/text-document-api/Enumeration/ContentControlProperties.md)对象添加了 *Shd* 和 *Border* 属性。
...
- 向 *window.Asc.plugin.executeMethod* 添加了[获取选中的 OLE 对象](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetSelectedOleObjects.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[设置插件选项](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/SetPluginsOptions.md)方法。
...
- 在简单类型定义中添加了 [OLE 属性](../interacting-with-editors/api-by-editor-type/text-document-api/Enumeration/OLEProperties.md)类型。
- 在简单类型定义中添加了[插件选项](../interacting-with-editors/api-by-editor-type/text-document-api/Enumeration/PluginOptions.md)类型。
...
- 向 *window.Asc.plugin.executeMethod* 的[显示按钮](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/ShowButton.md)方法添加了**对齐**参数。
...
- 向 *window.Asc.plugin.executeMethod* 添加了[获取文档语言](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetDocumentLang.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[鼠标移动窗口](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/MouseMoveWindow.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[鼠标释放窗口](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/MouseUpWindow.md)方法。
...
- 向 *window.Asc.plugin.executeMethod* 的[移除插件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/RemovePlugin.md)方法添加了备份参数。
- 向 *window.Asc.plugin.executeMethod* 的[获取选中文本](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetSelectedText.md)方法添加了换行符分隔参数。
- 向[图像数据](../interacting-with-editors/api-by-editor-type/text-document-api/Enumeration/ImageData.md)对象添加了替换模式参数。
...
- 向 *window.Asc.plugin.executeMethod* 添加了[获取 VBA 宏](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetVBAMacros.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[拖放事件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/OnDropEvent.md)方法。
...
- 向 *window.Asc.plugin.executeMethod* 添加了[获取下载文件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetFileToDownload.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了通过标签获取表单方法。
- 向 *window.Asc.plugin.executeMethod* 添加了获取表单值方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[从选区获取图像数据](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetImageDataFromSelection.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[获取已安装插件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/GetInstalledPlugins.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[安装插件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/InstallPlugin.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[将图像数据插入选区](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/PutImageDataToSelection.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[移除插件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/RemovePlugin.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了设置表单值方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[显示按钮](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/ShowButton.md)方法。
- 向 *window.Asc.plugin.executeMethod* 添加了[更新插件](../interacting-with-editors/api-by-editor-type/text-document-api/Methods/UpdatePlugin.md)方法。
- 添加了**失去焦点事件**。
- 添加了**内容控件变更事件**。
- 添加了**获得焦点事件**。
