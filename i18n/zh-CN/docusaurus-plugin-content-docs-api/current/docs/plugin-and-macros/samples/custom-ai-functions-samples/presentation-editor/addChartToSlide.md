...
该函数向指定幻灯片或当前幻灯片添加图表。默认情况下，图表大小为 152x89 mm 并居中显示。

## 提示词

- 在当前幻灯片上添加一个展示销售数据 [[100, 120, 140], [90, 110, 130]] 的条形图，系列名称为"Product A"和"Product B"，类别为"Q1"、"Q2"、"Q3"
- 在第 2 张幻灯片上添加一个展示数据 [[30, 25, 20, 15, 10]] 的饼图，系列名称为"Market Share"，类别为"Company A"、"Company B"、"Company C"、"Company D"和"Others"
- 生成 2024 年月度收入从 5 万美元稳定增长至 12 万美元的图表数据
...
| 名称        | 类型   | 示例                                                                            | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------- | ------ | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| slideNumber | number | 2                                                                               | 添加图表的幻灯片编号。如果省略，图表将添加到当前幻灯片。                                                                                                                                                                                                                                                                                                                                                                                                          |
| chartType   | string | "bar3D"                                                                         | 图表类型可以为 "bar"、"barStacked"、"barStackedPercent"、"bar3D"、"barStacked3D"、"barStackedPercent3D"、"barStackedPercent3DPerspective"、"horizontalBar"、"horizontalBarStacked"、"horizontalBarStackedPercent"、"horizontalBar3D"、"horizontalBarStacked3D"、"horizontalBarStackedPercent3D"、"lineNormal"、"lineStacked"、"lineStackedPercent"、"line3D"、"pie"、"pie3D"、"doughnut"、"scatter"、"stock"、"area"、"areaStacked"、"areaStackedPercent"。 |
| data        | array  | \[\[10, 20, 30, 40\], \[15, 25, 35, 45\], \[12, 22, 32, 42\]\]                  | 数值数据的二维数组。每个子数组必须具有相同的长度，且子数组的数量必须与系列数量匹配。                                                                                                                                                                                                                                                                                                                                                                              |
| series      | array  | \["Series 1", "Series 2", "Series 3"\]                                          | 系列名称数组，其长度必须与数据数组的数量相同。                                                                                                                                                                                                                                                                                                                                                                                                                    |
| categories  | array  | \["Jan", "Feb", "Mar", "Apr"\]                                                  | 类别名称数组，其长度必须与每个数据数组的长度相同。                                                                                                                                                                                                                                                                                                                                                                                                                |
| prompt      | string | "Create monthly revenue data for 2024 showing steady growth from $50k to $120k" | 用于描述图表所需生成数据的说明。                                                                                                                                                                                                                                                                                                                                                                                                                                  |
