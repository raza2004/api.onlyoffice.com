...
该函数向指定幻灯片或当前幻灯片添加任意文本内容。所有文本插入请求均可使用此函数，包括食谱、列表、说明、备注、想法或其他文本内容。
...
| 名称        | 类型   | 示例                                         | 描述                                                                                                                                                                                                                  |
| ----------- | ------ | -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| slideNumber | number | 2                                            | 添加文本的幻灯片编号。如果省略，文本将添加到当前幻灯片。                                                                                                                                                              |
| text        | string | "Introduction"                               | 要添加的文本内容。可包含食谱、列表、说明、备注、想法、描述、故事、数据或用户请求的任何其他文本。                                                                                                                      |
| textType    | string | "title"                                      | 文本类型可以为 "body"、"chart"、"clipArt"、"ctrTitle"、"diagram"、"date"、"footer"、"header"、"media"、"object"、"picture"、"sldImage"、"sldNumber"、"subTitle"、"table"、"title"。默认值为 "body"。                  |
