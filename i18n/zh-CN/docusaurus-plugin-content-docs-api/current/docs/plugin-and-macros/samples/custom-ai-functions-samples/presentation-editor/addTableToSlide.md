...
该函数向指定幻灯片或当前幻灯片添加表格。默认情况下，表格大小为 194x97 mm 并居中显示。

## 提示词

- 在第 2 张幻灯片上添加一个 3x3 的表格
- 在当前幻灯片上添加一个包含数据 [["Name", "Age", "City"], ["John", "30", "New York"], ["Jane", "25", "London"]] 的表格
- 添加一个简单的 2x4 表格
...
| 名称        | 类型   | 示例                                                                                    | 描述                                                                                                 |
| ----------- | ------ | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| slideNumber | number | 2                                                                                       | 添加表格的幻灯片编号。如果省略，表格将添加到当前幻灯片。                                             |
| rows        | number | 2                                                                                       | 行数。默认值为 3。                                                                                   |
| columns     | number | 4                                                                                       | 列数。默认值为 3。                                                                                   |
| data        | array  | \[\["Name", "Age", "City"\], \["John", "30", "New York"\], \["Jane", "25", "London"\]\] | 单元格值的二维数组，结构为行 × 列。                                                                  |
