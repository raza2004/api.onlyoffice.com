...
该函数在指定范围或当前选中范围内插入数据透视表。
可用于按行和值对数据进行汇总、分组或聚合。

## 提示词

- 插入数据透视表
- 使用数据透视表按 Column1 和 Column2 对数据分组
- 在数据透视表中对 Column3 进行数据聚合
...
| 名称        | 类型             | 示例                   | 描述                                                                                   |
| ----------- | ---------------- | ---------------------- | -------------------------------------------------------------------------------------- |
| range       | string           | "A1:D10"               | 数据透视表的数据来源单元格范围。若省略则使用活动或选中范围。                           |
| columns     | array of strings | ["Column1", "Column2"] | 用于数据透视行的列名数组（分类/分组列）。                                              |
| valueColumn | string           | "Column3"              | 用于数据透视值的列名（数值/聚合列）。                                                  |
