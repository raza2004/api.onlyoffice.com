...
该函数更改指定幻灯片的背景。支持纯色填充和渐变填充。

## 提示词

- 将第 1 张幻灯片的背景设置为蓝色
- 将第 2 张幻灯片的背景设置为颜色 #FF0000 和 #0000FF 的渐变
...
| backgroundType | string           | "solid"                  | 背景类型可以为 "solid"（纯色）或 "gradient"（渐变）。 |
| color          | string           | "#FF5733"                | 纯色背景的十六进制颜色代码。                   |
| gradientColors | array of strings | \["#FF0000", "#0000FF"\] | 渐变背景的十六进制颜色代码数组。               |
